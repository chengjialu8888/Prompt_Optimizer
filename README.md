...
![Prompt Optimizer — from intent to execution](assets/prompt-optimizer-header.jpg)
...
assets/
├── prompt-optimizer-header.jpg         # GitHub README hero image
...
assets/
├── prompt-optimizer-header.jpg         # GitHub README 头图
